...
﻿(function($){$.fn.qaTooltip=function(options){var opts=$.extend({},$.fn.qaTooltip.defaultOptions,options),$wrap=this;$wrap.each(function(){var $this=$(this);$this.css('position','relative');$this.find('a.tag').css('cursor','pointer');$this.onHover=false;function hoverOver(){$this.onHover=true;if(opts.useParentActiveClass){$this.addClass(opts.parentActiveClass);}
