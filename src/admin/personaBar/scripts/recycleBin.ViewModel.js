...
define(['jquery', 'knockout',
    ...
    DnnPageRecycleBin = (function () {
        ...
        var RECYCLE_PANEL_ID = '#recycleBin-panel';
        ...
        getService = function () {
            _utility.sf.moduleRoot = "EvoqContentLibrary";
        ...
        /* Class Methods */
        // ex: DnnPageRecycleBin.method = function () {};

        /* Public Methods */
        // ex: DnnPageRecycleBin.prototype.method = function () {};
        DnnPageRecycleBin.prototype.init = function () {
            var viewModel, recycleBinPanel;

            _options = $.extend({}, RECYCLE_BIN_DEFAULT_OPTIONS, _options);
            recycleBinPanel = $(RECYCLE_PANEL_ID);

            viewModel = getViewModel();
            ko.applyBindings(viewModel, recycleBinPanel[0]);
        };
        ...
        // DnnPageRecycleBin.prototype.privateMethodTest = privateMethod;
        /* end-test-code */
